//Continents java will print out the continent and the largest city in the continent using switch //
public class Continents {
  ...
  switch(continent){ 
    ...
    case 7: { System.out.println("Antartica: McMurdo Statin US");
    break;
      }
    case 8: { System.out.println("Undefined continent");
    break;
      }
	}
 }
